...
<html lang="en">
  <head>
    ...
    {{-- {{ asset('dashboard_assets/lib/font-awesome/css/font-awesome.css')}} --}}
              ...
              <nav class="nav">
                <div class="dropdown">
                  <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
                    ...
                    <img src="{{ asset('dashboard_assets')}}/img/shanto.jpg" class="wd-32 rounded-circle" alt="">
                  </a>
...
<footer class="sl-footer">
  <div class="footer-left">
    <div class="mg-b-2">Copyright &copy; {{ Carbon\Carbon::now()->format('Y') }} All Rights Reserved.</div>
    <div>Made by shanto</div>
  </div>
...
{{-- {{ asset('dashboard_assets/lib/jquery/jquery.js')}} --}}
