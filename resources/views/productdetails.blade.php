            ...
            <div class="row">
                    ...
                    <div class="product-single-img">
                        <div class="product-active owl-carousel">
                            ...
                            @foreach ($multiple_photos as $multiple_photo)
                                <div class="item">
                                    <img src="{{ asset('uploads/product_multiple_photos') }}/{{ $multiple_photo->photo_name }}"
                                        alt="">
                                </div>
                            @endforeach
                ...
                <div class="col-lg-6">
                    <div class="product-single-content">
                        ...
                        <h5>Available Quantity: {{ $product_info->product_quantity}}</h5>
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="featured-product-wrap">
                            <div class="featured-product-img">
                                <img src="{{ asset('uploads/product_photos') }}/{{ $related_product->product_thumbnail_photo }}"
                                    alt="not found">
                            </div>
                            <div class="featured-product-content">
                                <div class="row">
                                    <div class="col-7">
                                        <h3><a
                                                href="{{ url('product/details') }}/{{ $related_product->id }}">{{ $related_product->product_name }}</a>
                                        </h3>
